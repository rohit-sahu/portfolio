...
// Creates or updates an entry in secrets/admin-users.json without ever
// printing, logging, or writing the plaintext password anywhere — only the
// bcrypt hash is persisted. Run with: npm run admin:create
